...
![The rooted A2 board: the seed destroys translation symmetry but leaves a D6 stabiliser.](../reports/connect6_theory_book_evidence/figures/hex_d6_board.png)
...
![A length-6 progression is a winning hyperedge.](../reports/connect6_theory_book_evidence/figures/length6_progression.png)
...
![Obligations form a small hitting problem; tactics live in the transversal, not the threat count.](../reports/connect6_theory_book_evidence/figures/obligation_hitting.png)
...
![Two primitive bills: singleton and pair triads both force tau = 3 against a two-stone defender.](../reports/connect6_theory_book_evidence/figures/obligation_triads.png)
...
![One-cap cooling: Black spends one stone to reduce White's next line tax from tau = 2 to tau = 1.](../reports/connect6_theory_book_evidence/figures/one_cap_cooling.png)
...
![White's early overload search: the scans found taxes, not overloads.](../reports/connect6_theory_book_evidence/figures/opening_evidence.png)
...
![The atom-mining loop turns zone failures into canonical forcing witnesses.](../reports/connect6_theory_book_evidence/figures/atom_pipeline.png)
...
![Strategy families compared by mean tactical score in the radius-3 self-play grid.](../reports/connect6_theory_book_evidence/figures/strategy_matrix.png)
...
![Connect-k sweep: prime and odd/even lengths as rhythm probes, not final theorems.](../reports/connect6_theory_book_evidence/figures/parity_sweep.png)

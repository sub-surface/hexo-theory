...
- geometric realizations: 569
- abstract atom types: 2
- shared abstract atom types across lattices: 1
- lattice counts: {'A2_hex': 12, 'Z2_diag': 557}
- family counts: {'C5 pair atom': 557, 'K4 pair atom': 12}
...
- `evidence/figures/`: count, overlap, size, spectral, and representative diagrams.

...
Output:
  ...
  - data/metrics.json
  - evidence/figures/periodic_table_of_forcing_atoms.png
  - evidence/figures/periodic_table_by_family.png
  - evidence/figures/element_frequency_rank.png
  - evidence/figures/bulk_boundary_compression.png
  - evidence/figures/element_embedding_multiplicity.png
  - evidence/figures/family_tau_pressure_map.png
  - evidence/figures/top_element_cards.png
  - evidence/figures/element_embedding_multiplicity_by_tau.png

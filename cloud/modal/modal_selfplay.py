...
Same corpus schema as evidence/results/modal_moves_python_8000.json: games as
...
many leading placements were the seeded opener's).
    ...
    modal run cloud/modal/modal_selfplay.py::generate --n-games 400 --budget-s 0.5
"""
...
def generate(n_games: int = 400, budget_s: float = 0.5, max_moves: int = 400,
    ...
    out_path = Path(out) if out else RESULTS_ROOT / "hexo_bot2_selfplay.json"
